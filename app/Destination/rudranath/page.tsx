...
export default function RudranathPage() {
    ...
    const locationData = {
        title: "RUDRANATH",
        description: "Visit the fifth temple of Panch Kedar, where Lord Shiva's face is worshipped",
        ...
        gallery: [
            {
                src: "https://i.pinimg.com/736x/ab/4d/f0/ab4df0133fcbd73e964977326c3116b3.jpg",
                alt: "Rudranath Temple Front View"
            },
            {
                src: "https://i.pinimg.com/736x/81/d8/92/81d892835b8739e783c5146dd2ac1349.jpg",
                alt: "Temple Architecture"
            },
            {
                src: "https://i.pinimg.com/736x/c4/12/f9/c412f9a2b5fc86221f0802d55e3941c9.jpg",
                alt: "Mountain Panorama"
            },
            {
                src: "https://i.pinimg.com/736x/a9/73/c9/a973c94e29b260c11b74f528e800d419.jpg",
                alt: "Trek Path to Temple"
            },
            {
                src: "https://i.pinimg.com/736x/78/34/3d/78343df1a58c9d65e662bfe9f607a5dd.jpg",
                alt: "Temple Surroundings"
            },
            {
                src: "https://i.pinimg.com/736x/17/54/6e/17546e3aa592b646a52890169adcbc04.jpg",
                alt: "Temple Interior"
            },
            {
                src: "https://i.pinimg.com/736x/43/ac/01/43ac0174ccd4055ba185d619143b921d.jpg",
                alt: "Himalayan Landscape"
            },
            {
                src: "https://i.pinimg.com/736x/47/87/d2/4787d24715d8e38496e75e6ccabd0c5a.jpg",
                alt: "Trekking Trail"
            }
        ]
    };
                            ...
                            <div className="flex flex-col md:flex-row gap-8">
                                <div className="flex-grow prose max-w-none md:w-2/3">
                                    ...
                                    <p className="text-lg text-gray-600 leading-relaxed">
                                        Rudranath Temple is the third temple in the Panch Kedar circuit, where Lord Shiva's face is worshipped. Located at an altitude of 2,286 meters, this ancient temple is surrounded by dense forests and offers a serene spiritual experience. The temple is known for its unique natural rock formation that resembles Lord Shiva's face. The journey to Rudranath is not just a pilgrimage but also an opportunity to experience the pristine beauty of the Garhwal Himalayas.
                                    </p>
                                </div>
                            ...
                            {[
                                {
                                    ...
                                    details: [
                                        ...
                                        "Reach Sagar Village by 3 PM",
                                        "Dinner at Sagar",
                                        "Overnight stay at Sagar (HomeStay)"
                                    ]
                                },
                                {
                                    day: "Day 2",
                                    ...
                                    details: [
                                        ...
                                        "Start trek from Sagar at 7 AM for Lyuti Bugyal",
                                        "Breakfast at Sagar",
                                        "Reach Lyuti Bugyal by 2 PM",
                                        "Dinner at Lyuti",
                                        "Overnight stay at Lyuti (Camps)"
                                    ]
                                },
                                {
                                    day: "Day 3",
                                    ...
                                    details: [
                                        ...
                                        "Start trek from Lyuti Camps to Rudranath Temple",
                                        "Breakfast at Lyuti",
                                        "Reach Rudranath by 11 AM",
                                        "Return back to Lyuti by 4 PM",
                                        "Dinner at Lyuti",
                                        "Overnight stay at Lyuti (Camps)"
                                    ]
                                },
                                {
                                    day: "Day 4",
                                    title: "Lyuti to Sagar to Kalpeshwar to Sagar",
                                    details: [
                                        "Trek from Lyuti to Sagar",
                                        "Drive towards Kalpeshwar",
                                        "Breakfast at Lyuti",
                                        "Reach Kalpeshwar by 2 PM",
                                        "Return back to Sagar",
                                        "Dinner at Sagar",
                                        "Overnight stay at Sagar (HomeStay)"
                                    ]
                                },
                                {
                                    day: "Day 5",
                                    title: "Sagar to Rishikesh",
                                    details: [
                                        "Drive Distance: 220 km | Drive Time: 6-7 hours",
                                        "Start drive from Sagar to Rishikesh",
                                        "Breakfast at Sagar",

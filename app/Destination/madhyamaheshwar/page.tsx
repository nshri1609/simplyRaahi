...
export default function MadhyamaheshwarPage() {
    ...
    const locationData = {
        ...
        pdfLink: "https://drive.google.com/file/d/1u3l7i3FPzqx-yIXwAW5egbtRjVQYjenc/view?usp=sharing",
        whatsappNumber: "919876543210",
        phoneNumber: "919876543210",
        email: "info@simplyraahi.com",
        gallery: [
            {
                src: "https://i.pinimg.com/736x/04/97/24/04972436b7cec39843fcb33910bdd3d8.jpg",
                alt: "Madhyamaheshwar Temple"
            },
            {
                src: "https://i.pinimg.com/736x/80/c1/ed/80c1ede5e12d5b074a5df3682e73d8c3.jpg",
                alt: "Temple View"
            },
            {
                src: "https://i.pinimg.com/736x/b8/1a/01/b81a016cec4db1a72bcd42f74313e488.jpg",
                alt: "Mountain View"
            },
            {
                src: "https://i.pinimg.com/736x/6d/ce/67/6dce6735a97b9397f2c6b9113beffc0f.jpg",
                alt: "Trek Path"
            },
            {
                src: "https://i.pinimg.com/736x/34/82/65/348265402b09dd6a97d389b2f8ae9e74.jpg",
                alt: "Temple Architecture"
            },
            {
                src: "https://i.pinimg.com/736x/5d/ad/d1/5dadd1c09e7fb6cca3eb51db1d7586f7.jpg",
                alt: "Scenic View"
            },
            {
                src: "https://i.pinimg.com/736x/96/45/fc/9645fcf05b72d8cb7705f4e66cab02a0.jpg",
                alt: "Mountain Landscape"
            },
            {
                src: "https://i.pinimg.com/736x/a0/7e/05/a07e0592f9d0a38ca12fa9631426fb8b.jpg",
                alt: "Trekking Route"
            }
        ]
    };
                            ...
                            <div className="flex flex-col md:flex-row gap-8">
                                <div className="flex-grow prose max-w-none md:w-2/3">
                                    ...
                                    <p className="text-lg text-gray-600 leading-relaxed">
                                        Madhyamaheshwar is the fourth temple in the Panch Kedar circuit, where Lord Shiva's navel is worshipped. Located at an altitude of 3,497 meters, this ancient temple offers a perfect blend of spiritual significance and natural beauty. The temple is surrounded by snow-capped peaks and offers breathtaking views of the Garhwal Himalayas. The trek to Madhyamaheshwar takes you through beautiful meadows, dense forests, and traditional mountain villages, making it a memorable experience for both devotees and nature lovers.
                                    </p>
                                </div>
                    ...
                    {activeTab === "Itinerary" && (
                        ...
                        >
                            ...
                            {[
                                {
                                    day: "Day 1",
                                    title: "Rishikesh to Ransi to Upper Bantoli",
                                    details: [
                                        "Drive Distance: 200 km | Drive Time: 6-7 hours",
                                        "Trek Distance: 6 km | Trek Time: 2-3 hours",
                                        "Pickup from Rishikesh (Nepali Farm, Tapovan) 6 AM-8 AM",
                                        "Reach Ransi Village by 1 PM",
                                        "Trek 6 km to Upper Bantoli",
                                        "Dinner at Upper Bantoli",
                                        "Overnight stay at Upper Bantoli (HomeStay)"
                                    ]
                                },
                                {
                                    day: "Day 2",
                                    ...
                                    details: [
                                        ...
                                        "Start trek from Upper Bantoli to Madhyamaheshwar",
                                        "Breakfast at Upper Bantoli",
                                        "Reach Madhyamaheshwar by 2 PM",
                                        "Dinner at Madhyamaheshwar",
                                        "Overnight stay at Madhyamaheshwar (HomeStay)"
                                    ]
                                },
                                {
                                    day: "Day 3",
                                    ...
                                    details: [
                                        "Trek Distance: 20 km | Trek Time: 8-9 hours",
                                        "Early morning trek to Bhuda Madhyamaheshwar",
                                        "Watch sunrise at Bhuda Madhyamaheshwar",
                                ...
                                {
                                    day: "Day 4",
                                    title: "Ransi to Rishikesh",
                                    details: [
                                        "Drive Distance: 200 km | Drive Time: 6-7 hours",
                                        "Start drive from Ransi Village to Rishikesh",
                                        "Breakfast at Ransi",
                                        "Reach Rishikesh by 2 PM",
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-white rounded-xl shadow-lg p-6">
                                        ...
                                        <ul className="space-y-3">
                                            {[
                                                "Stay: Accommodation on triple-sharing basis (single/double at extra cost)",
                                                "Transport: Transportation from Rishikesh to Rishikesh",
                                                "Meals: All meals from Day 1 dinner to last day breakfast",
                                                "Trek Equipment: Sleeping bags, tents, utensils, mattresses",
                                                "Forest Entry and Permits: All charges covered",
                                                "Trek Staff: Certified trek leader, guide, cook, support staff",
                                                "Emergency Kit: First aid, oxygen cylinders, stretchers"
                                            ].map((item, i) => (
                                    ...
                                    <div className="bg-white rounded-xl shadow-lg p-6">
                                        ...
                                        <ul className="space-y-3">
                                            {[
                                                ...
                                                "Any expenses from emergencies during trip",
